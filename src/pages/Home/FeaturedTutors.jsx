...
const FeaturedTutors = () => {
  ...
  return (
    ...
    >
      {/* Outer body-width container */}
      <div className="max-w-7xl mx-auto px-4 md:px-8 w-full">
        
        {/* Inner content box */}
        <div
          className={`flex flex-col lg:flex-row items-center justify-between gap-8 w-full rounded-3xl p-6 sm:p-8 md:p-12 transition-all duration-300 ${
            isDark
              ? 'bg-slate-800/80 border border-slate-700 shadow-2xl shadow-slate-900/50'
              : 'bg-white/85 shadow-2xl shadow-indigo-200/20'
          }`}
        >
          {/* Left side: Text + Tutors */}
